			...
			init: function() {
				...
				// Skel.
					skel.init({
						...
						containers: '100%',
						breakpoints: {
							global: { range: '*', href: theme_url + '/assets/css/style.css' },
							desktop: { range: '737-', href: theme_url + '/assets/css/style-desktop.css', viewport: { width: 1280, scalable: false } },
							mobile: { range: '-736', href: theme_url + '/assets/css/style-mobile.css', viewport: { scalable: false } }
						}
					});
